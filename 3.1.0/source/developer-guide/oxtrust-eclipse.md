...
**All Gluu applications store setting in LDAP. Hence we need to update their configuration in LDAP.**

3.1\. Remove `IDPAuthentication` from `inum=<appliance_inum>,ou=appliances,o=gluu` where appliance_inum is unknown.
